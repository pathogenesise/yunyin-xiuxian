...
**功法悟道** — 46 部功法分主修、辅修、秘术三类，可同时装配；练至圆满开启悟道分支，107 条分支让同一部功法走出不同流派

**历练探险** — 44 个区域自青云山麓至九幽魔渊，132 种敌人；派遣式历练按时间安排遭遇，79 个随机事件 + 11 类机缘穿插其间，首领通关解锁下一区

**回合制战斗** — 战斗在后台一次性完整解算再回放：速度先手、暴击闪避、护盾吸血、反击连击、控制、法宝、流派组合技（玄罡反震/枯泽回春/锋连诀）全部参与推演

**装备构筑** — 10 个装备槽位、77 种模板、113 条词条、9 级品质（凡品→神品）；同类词条按 1/0.75/0.5/0.25 递减，攻击生命速度等超过软阈值后收益衰减，逼你搭配而非单堆

**器魂形意** — 飞升之后天道压顶，数值被尽数抹平，凡器只余形意：销毁装备凝出 6 类 6 阶器魂（锋/盾/棘/连/泽/背），3 个装配槽位；想更强只能改路数，不能靠更厚的数值

**洞府经营** — 7 种建筑（洞府/聚灵阵/炼丹炉/炼器台/灵田/藏经阁/灵兽园）离线产出，4 条灵脉（青木/赤炎/玉髓/寒冥）可投资分红

**炼丹炼器** — 9 门技艺（识材/辨药/配伍/凝丹/淬药/养丹/控火/锻打/铭纹）各自成长，50 种丹药、33 件法宝；技艺不足不是"不能炼"，而是炼出什么样的成品

**灵兽相伴** — 12 只灵兽（青羽灵狐/雪背小龟/赤火雀/月影狸/三足金蟾/摇光鹿/御雷猴/螭龙幼子/应龙/麒麟/鲲鹏/混沌饕餮），出战加成各异，性子还会改历练中的遭遇走向
...
| 功法 | 46 部（主修 / 辅修 / 秘术），圆满后开启 107 条悟道分支                       |
| 历练 | 44 区域 × 132 敌人，派遣制会话，79 事件 + 11 机缘，首领解锁下一区            |
| 战斗 | 后台完整预解算再回放，速度 / 暴击 / 护盾 / 吸血 / 反击 / 控制 / 组合技       |
| 装备 | 10 槽位 × 77 模板 × 113 词条 × 9 品质，词条递减 + 软阈值                     |
| 器魂 | 飞升后数值归零，6 类 × 6 阶器魂占 3 个槽位，改路数而非堆数值                 |
| 洞府 | 7 建筑离线产出 + 4 条灵脉投资分红                                            |
| 技艺 | 9 门（识材 / 辨药 / 配伍 / 凝丹 / 淬药 / 养丹 / 控火 / 锻打 / 铭纹）独立成长 |
| 炼制 | 50 丹药 + 33 法宝，技艺水平决定成品品相而非成败                              |
| 灵兽 | 12 只，出战加成与性子各异                                                    |
