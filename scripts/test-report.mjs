...
const CATEGORIES = [
  {
    name: 'Unit        数值纯函数',
    match: ['gnum', 'format', 'savePlaintext', 'useNativeInsets', 'formulas', 'linggenGen', 'equipGen', 'crypto', 'quests', 'codex', 'craftability', 'reforge', 'theme', 'savePersistence', 'dongfu.spec', 'ui.spec']
  },
  {
    name: 'Combat      战斗规则',
