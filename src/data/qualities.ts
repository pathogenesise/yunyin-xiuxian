...
export const QUALITIES: QualityDef[] = [
  { id: 'mortal', name: '凡品', rank: 0, mult: 1.0, affixes: [0, 1], fromTier: 1, toTier: 12, weight: QUALITY_WEIGHTS[0], color: '#857F70' },
  { id: 'fine', name: '良品', rank: 1, mult: 1.25, affixes: [1, 2], fromTier: 1, toTier: 16, weight: QUALITY_WEIGHTS[1], color: '#6E8B74' },
  { id: 'excellent', name: '精品', rank: 2, mult: 1.6, affixes: [2, 3], fromTier: 2, toTier: 20, weight: QUALITY_WEIGHTS[2], color: '#4F7699' },
  { id: 'spirit', name: '灵品', rank: 3, mult: 2.1, affixes: [2, 4], fromTier: 4, toTier: 24, weight: QUALITY_WEIGHTS[3], color: '#7B5EA7' },
  { id: 'profound', name: '玄品', rank: 4, mult: 2.8, affixes: [3, 5], fromTier: 8, toTier: 27, weight: QUALITY_WEIGHTS[4], color: '#A85C3F' },
  { id: 'earth', name: '地品', rank: 5, mult: 3.7, affixes: [4, 6], fromTier: 12, toTier: 29, weight: QUALITY_WEIGHTS[5], color: '#B07D2B' },
  ...
  { id: 'divine', name: '神品', rank: 8, mult: 9.5, affixes: [6, 9], fromTier: 24, toTier: 32, weight: QUALITY_WEIGHTS[8], color: '#A83F39' }
]
