...
export const TALENTS: TalentDef[] = [
  ...
  t('t_tianming', '天命', 3, '天命所归,小进阶更顺', { breakthroughRate: 0.05, luck: 0.05 }),
  t('t_changsheng', '长生', 3, '寿数绵长,岁月不侵', { lifespanPct: 0.3 }),
  t('t_daogu', '道骨', 1, '根骨清奇,修行略快', { cultivationSpeed: 0.08 }),
  t('t_linggen', '灵慧', 1, '天资聪颖,战胜修为更丰', { expGain: 0.1 }),
  t('t_tiegu', '铁骨', 1, '筋骨强健,皮糙肉厚', { maxHpPct: 0.1, defensePct: 0.05 }),
  t('t_xunjie', '迅捷', 1, '身轻如燕,抢先更容易', { speed: 0.08 }),
  t('t_jufu', '聚福', 1, '小富即安,战胜多拾灵石', { spiritStoneGain: 0.12 }),
  t('t_shanbu', '善补', 1, '疗伤有方,恢复迅速', { regenPerRound: 0.01, maxHpPct: 0.05 }),
  t('t_yuanman', '圆融', 2, '道基圆融,小进阶更稳', { breakthroughRate: 0.03, breakRefund: 0.1 }),
  ...
  t('t_yaoyuan', '妖缘', 2, '同程多遇,装备更易现', { explorationSpeed: 0.12, dropRate: 0.06 }),
  t('t_danxin', '丹心', 2, '炉火纯青,更易双枚成丹', { alchemyYield: 0.2 }),
  t('t_qiao', '巧匠', 2, '强化更省,祭炼不吃', { forgeDiscount: 0.15 }),
  t('t_wugou', '无垢', 3, '道心无垢,小进阶不滞', { cultivationSpeed: 0.1, breakthroughRate: 0.04 }),
  ...
  t('t_hongyun', '鸿运', 4, '鸿运当头,小进阶亦顺', { luck: 0.2, breakthroughRate: 0.06, dropRate: 0.1 }),
